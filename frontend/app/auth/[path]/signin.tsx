        ...
        <div className="w-full min-h-screen bg-gray-50 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div className="container w-full sm:max-w-md p-5 mx-auto">
                ...
                <div className='flex flex-row justify-center'>
                    <button className="mt-3 border-2 rounded-lg items-center justify-center inline-flex flex-row px-3 py-2 hover:bg-stone-100" onClick={() => { beginGoogleOAuthSignin() }}>
